...
const About = () => {
  ...
  return (
    <>
      ...
      <div className="bg-red-400 sm:bg-yellow-400 md:bg-purple-400 relative isolate overflow-hidden px-6 py-24 sm:py-32 lg:overflow-visible lg:px-0">
      ...
      <div className="lg:col-span-2 lg:col-start-1 lg:row-start-1 lg:mx-auto lg:grid lg:w-full lg:max-w-7xl lg:grid-cols-2 lg:gap-x-8 lg:px-8">
        <div className="lg:pr-4">
          <div className="lg:max-w-lg">
              ...
              <h1 className="mt-2 text-3xl font-bold tracking-tight text-gray-900 sm:text-4xl">What is Dreams Endeavour ?</h1>
